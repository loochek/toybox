...
void test_basic()
{
    ...
    for (int i = 0; i < 10; i++)
        assert(*list_at(&list, i) == correct1[i]);
    ...
    for (int i = 0; i < 10; i++)
        assert(*list_at(&list, i) == correct3[i]);
...
void test_advanced()
{
    ...
    {
        assert(list_insert(&list, i, cnt) == LIST_OK);
        cnt++;
    }
    ...
    for (int i = 1; i <= 10; i++)
        assert(list_remove(&list, i) == LIST_OK);
    ...
    for (int i = 0; i < 9; i++)
        assert(list_remove(&list, 0) == LIST_OK);
